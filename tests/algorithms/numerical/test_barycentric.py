...
Unit tests for the functions in the andz.algorithms.numerical.barycentric
module.
"""

import unittest

from andz.algorithms.numerical.barycentric import barycentric, compute_weights
