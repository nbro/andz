...
Unit tests for the functions in the andz.algorithms.numerical.horner module.
"""
...
from andz.algorithms.numerical.horner import horner
...
class TestHorner(unittest.TestCase):
    ...
    def test_one(self):
        self.assertAlmostEqual(
            horner(self.x0, self.coefficients), polyval(self.x0, self.coefficients)
        )
