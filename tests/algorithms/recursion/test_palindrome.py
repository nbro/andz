...
Unit tests for the functions in the andz.algorithms.recursion.palindrome
module.
"""
...
from andz.algorithms.recursion.palindrome import is_palindrome, iterative_is_palindrome
