...
def make_test(func: callable):
    class TestIsPalindrome(unittest.TestCase):
        ...
        def test_size_1(self):
            self.assertTrue(
                func(TestIsPalindrome.generate_palindrome(1)))

        def test_size_2(self):
            self.assertTrue(
                func(TestIsPalindrome.generate_palindrome(2)))
        ...
        def test_random_size(self):
            n = randint(3, 100)
            self.assertTrue(
                func(TestIsPalindrome.generate_palindrome(n)))
