...
andz.algorithms.sorting.comparison.selection_sort module.
"""

import unittest

from andz.algorithms.sorting.comparison.selection_sort import selection_sort
...
class TestSelectionSort(unittest.TestCase, SortingAlgorithmTests):
    def __init__(self, method_name="__init__"):
        ...
        SortingAlgorithmTests.__init__(self, selection_sort)
