...
andz.algorithms.sorting.integer.counting_sort module.
"""
...
from andz.algorithms.sorting.integer.counting_sort import counting_sort
    ...
    class TestCountingSort(unittest.TestCase, SortingAlgorithmTests):
        def __init__(self, method_name="__init__"):
            ...
            SortingAlgorithmTests.__init__(
                self, counting_sort, in_place=False, start=0, end=10000
            )
