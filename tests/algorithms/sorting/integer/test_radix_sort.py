...
Unit tests for the functions in the ands.algorithms.sorting.integer.radix_sort
module.
"""

import unittest

from ands.algorithms.sorting.integer.radix_sort import radix_sort
...
class TestRadixSort(unittest.TestCase, SortingAlgorithmTests):
    def __init__(self, method_name="__init__"):
        ...
        SortingAlgorithmTests.__init__(self, radix_sort,
                                       in_place=False,
                                       start=0,
                                       end=10000)
