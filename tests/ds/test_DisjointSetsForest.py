...
Unit tests for the classes and functions in the andz.ds.DisjointSetsForest
module.
"""
...
from andz.ds.DisjointSetsForest import DisjointSetsForest, _DSFNode
...
class TestDSForests(unittest.TestCase):
    ...
    def test_print_set(self):
        ...
        # Merge i and i+1 into the same set.
