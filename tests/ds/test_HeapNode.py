...
Tests for the BHNode class in Heap.py.

"""

import unittest

from ands.ds.Heap import BHNode


class TestHeapNode(unittest.TestCase):
    def test_creation_argument_None(self):
        self.assertRaises(ValueError, BHNode, None)
